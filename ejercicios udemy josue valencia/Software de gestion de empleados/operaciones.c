...
int alta(struct empleado empleados[100], int num_emp){
    ...
    if(num_emp < 100){
        ...
        printf("No se dar de alta el empleado. Cupo alcanzado");
...
void consultarDatosEmpleado(struct empleado empleados[100], int num_emp){
    ...
    int id;
    printf("Introduce Id del usuario cuyos datos quieres consultar\n");
    scanf("%d",&id);
